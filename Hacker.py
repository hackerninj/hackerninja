#Script Given By technology
#Script Is Given For Educational Purpose
#Script Edited By @Hacker Ninjae
#Utf-8 python 
...
\033[1;92m\n88888 8888 .d88b 8   8    
  ...
  8   8888 *Y88P 8   8                              
\n\033[0m----------------------------------
\033[1;92mAuthor \033[1;93m: Technology 
\033[1;92mFb \033[1;93m: Hacker Ninjae
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/HACKERZAM/')
        main()
    else:
        print ''
